...
mkdir -p $HOME/gopath/src/github.com/github.com/kaitai-io/
cp -v -r $HOME/gopath/src/github.com/cugu/kaitai_struct_go_runtime $HOME/gopath/src/github.com/github.com/kaitai-io
